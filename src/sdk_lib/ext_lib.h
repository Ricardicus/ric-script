...
#define EXPORT_MODULE(name) MARK_EXPORT char* EXPORT_MOD_NAME = name;\
MARK_EXPORT size_t EXPORT_MOD_NBR_FUNCS () { return sizeof(EXPORT_FUNCTION_LIST)/sizeof(*EXPORT_FUNCTION_LIST); } \
