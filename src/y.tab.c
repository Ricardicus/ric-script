...
#line 251 "gram.y"
    {
        ...
        expr_t *cond = newConditional(CONDITION_GE, (yyvsp[-2].data), expr);
...
#line 257 "gram.y"
    {
        expr_t *expr = newExpr_Ival(0);
        expr_t *cond = newConditional(CONDITION_GE, (yyvsp[-3].data), expr);
...
#line 267 "gram.y"
    {
        expr_t *expr = newExpr_Ival(0);
        expr_t *cond = newConditional(CONDITION_GE, (yyvsp[-4].data), expr);
